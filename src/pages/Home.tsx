...
function Home() {
  return (
    <main className="h-screen w-full flex justify-center">
        <img src={miku} alt="Hyprland wallpaper" className='absolute inset-0 w-full h-full object-cover -z-10'/>
        ...
        <section className="flex justify-center align-center flex-col">
            ...
            <p className="text-lg text-center text-dark font-semibold mt-4">
                ...
                De los assets y dependencias necesarias funcionan correctamente.
                <br />
                A desarrollar tu aplicación con React, TypeScript y Tailwind CSS.
